      ...
      <div className="flex-1 min-h-0 h-full flex flex-col min-w-0">
        ...
        >
          ...
          <div 
            className={
              activeTab === 'landing' 
                ? "relative z-10 w-full max-w-[1880px] xl:max-w-[1880px] mx-auto flex flex-col animate-fade-in my-0 min-h-full h-auto py-0 flex-auto shrink-0 justify-start" 
                : activeTab === 'return'
            ...
            style={{ minHeight: activeTab === 'landing' ? 'max(100%, max-content)' : undefined }}
          >
            <div 
              className={activeTab === 'landing' ? "flex-auto shrink-0 flex flex-col min-h-full h-auto" : "flex-1 min-h-0 flex flex-col"}
              style={{ minHeight: activeTab === 'landing' ? 'max(100%, max-content)' : undefined }}
            >
