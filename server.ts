...
৩. **শিরোনাম ও স্থানীয় প্রতিষ্ঠানের জবাব এক্সট্র্যাকশন ও প্রমিতকরণ (TITLE & REPLY TEXT EXTRACTION)**:
   - **শিরোনাম (Title)**: মূল নথিতে আপত্তির যে শিরোনাম লেখা আছে (যেমন: "ক্যাশ ক্রেডিট ঋণের মেয়াদোত্তীর্ণ অনাদায়ী ও শ্রেণীকৃত টাকা ৮,৪১,২৮৪/-"), তা নির্ভুলভাবে titleAndDetails এবং জারিপত্রের paraTitle এ বসান। কোনো বানান ভুল থাকলে (যেমন 'মেয়াদ উত্তীর্ণ' বা 'শ্রেণীকৃত') তা প্রমিত বানান অনুযায়ী শুদ্ধ করুন।
   - **স্থানীয় প্রতিষ্ঠানের জবাব (entityReplyHeader)**: মূল নথির ২য় পাতায় "শাখার জবাব" বা "প্রতিষ্ঠানের জবাব" অংশে যে বক্তব্য লেখা আছে, অপ্রয়োজনীয় বাহুল্য কথা বাদ দিয়ে মূল কথাটি হুবহু/সংক্ষেপে তুলে আনুন এবং কোনো বানান ভুল থাকলে শুদ্ধ করুন (যেমন: "ক্যাশ ক্রেডিট ঋণের আওতায় প্রদত্ত ৪টি ঋণগ্রহীতা প্রতিষ্ঠান যথাক্রমে ১) মো: আবুল খায়ের খান, ২) মো: হাসমত আলী, ৩) আবুল কালাম আজাদ এবং ৪) এস আর রাকিব স্টোরস এর বকেয়া ঋণ ইতিমধ্যে সুদআসলে আদায়পূর্বক সমন্বয় করা হয়েছে, যা নিম্নোক্ত ছকে উপস্থাপন করা হলো:")।
   - **ছক (Table)**: মূল নথিতে যদি আদায়ের বিবরণী বা সমন্বয়ের কোনো ছক/টেবিল থাকে, তবে অবশ্যই "hasTable": true দিন এবং প্রতিটি সারির (Row) কলামসমূহ (ক্র: নং, ঋণগ্রহীতার নাম, হিসাব নং ও প্রকৃতি, আপত্তিতে জড়িত টাকা, আসল, সুদ, অন্যান্য, মোট আদায়, সমন্বয়ের তারিখ) শুদ্ধ ও সুবিন্যস্তভাবে "tableRows" এ এক্সট্র্যাক্ট করুন।
