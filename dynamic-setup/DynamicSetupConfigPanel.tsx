    ...
    <div className="bg-white border border-slate-200 rounded-[2.5rem] p-8 shadow-xl space-y-8 animate-in fade-in duration-500">
      <div className="flex items-center justify-between border-b border-slate-100 pb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-2xl font-black text-slate-800 tracking-tight">ডাইনামিক প্রারম্ভিক জের সেটআপ</h2>
            <p className="text-sm font-bold text-slate-500">ডাটার ওপর ভিত্তি করে স্বয়ংক্রিয় প্রারম্ভিক জের তৈরি করুন</p>
          </div>
        </div>
      ...
      <div className="bg-blue-50 border border-blue-100 p-6 rounded-3xl flex gap-4 items-start">
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs font-bold text-blue-700 leading-relaxed">
            আপনি যে সময়কাল নির্ধারণ করে দেবেন, সেই সময়ের মধ্যে এন্ট্রি করা সমস্ত ডাটা (মীমাংসা রেজিস্টার) থেকে স্বয়ংক্রিয়ভাবে প্রারম্ভিক জের হিসাব করা হবে। এটি সক্রিয় থাকলে মাসিক রিটার্ণ (অনুচ্ছেদ) রিপোর্টে এই ডাইনামিক ডাটা প্রদর্শিত হবে।
          </p>
        </div>
      </div>
