          ...
          <table className="w-full border-separate border-spacing-0 !table-auto border-l border-slate-400">
            ...
            <tfoot className="qr-sticky-footer-bottom">
              <tr className="h-[36px]">
                ...
                <td className={`${footerTdCls} text-center font-black w-[95px] min-w-[95px] max-w-[95px] text-[10px]`}>মোট (টেবিল-১)</td>
              ...
              <tr className="h-[36px]">
                <td className={`${footerTdCls} w-[30px] min-w-[30px] max-w-[30px]`}></td>
                <td className={`${footerTdCls} w-[75px] min-w-[75px] max-w-[75px]`}></td>
                <td className={`${footerTdCls} text-center font-black w-[95px] min-w-[95px] max-w-[95px] text-[10px]`}>মোট (টেবিল-২)</td>
              ...
              <tr className="h-[36px]">
                ...
                <td className="border-r border-b border-slate-400 p-1 text-[10px] text-slate-900 align-middle bg-slate-300 font-extrabold text-center w-[95px] min-w-[95px] max-w-[95px] text-[10px]">সর্বমোট</td>
