...
const ReturnSummaryTable: React.FC<ReturnSummaryTableProps> = ({
  ...
  return (
    <div id="section-report-summary" className="space-y-4 py-2 w-full animate-report-page relative">
      ...
      <div id="card-report-table-container" className="bg-white border border-slate-300 shadow-2xl w-full p-1 relative animate-table-entrance">
        ...
        <div className="table-responsive-container border border-slate-300 relative rounded-lg">
