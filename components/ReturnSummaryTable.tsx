      ...
      <div id="card-report-table-container" className="bg-white border border-slate-300 shadow-2xl w-full overflow-x-auto p-1 relative animate-table-entrance">
        <div className="text-center mb-8 pt-4">
          ...
          <div className="mb-4 flex flex-col items-center gap-3">
            ...
            {isCustomBalanceActive ? (
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-blue-50 text-blue-700 rounded-xl text-[10px] font-black border border-blue-200 shadow-sm">
                <Sparkles size={12} className="text-blue-500" />
                কাস্টম প্রারম্ভিক জের সক্রিয় ({toBengaliDigits(isCustomBalanceActive.startDate.split('-').reverse().join('/'))} হতে {toBengaliDigits(isCustomBalanceActive.endDate.split('-').reverse().join('/'))})
              </div>
