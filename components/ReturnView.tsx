...
const ReturnView: React.FC<ReturnViewProps> = ({ 
  ...
  // Calculation Logic from Part 1 applied for recursive opening
    ...
    pastEntries.forEach(entry => {
        ...
        if (entry.paragraphs) {
          entry.paragraphs.forEach(p => {
            ...
            // AMOUNT PRECISION FIX: Use recovered + adjusted
            ...
            if (p.id && !processedParaIds.has(p.id) && hasDigit) {
              ...
              // All settled amounts contribute, but only Full increments count
              pastSA += settledAmt;
            }
          });
        }
  ...
  // Main Reporting Data Logic (Merged logic)
