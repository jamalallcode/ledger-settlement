...
import { parseDocumentEntry } from "./documentParser";
import {
...
export const DocumentManagementModule: React.FC<DocumentManagementModuleProps> = ({
  ...
  const handleRunAiAnalysis = async () => {
    ...
    setAiAnalysisStep("নথি ও প্রমাণক পর্যালোচনা করা হচ্ছে...");
    ...
    try {
      ...
      if (data && data.data) {
        ...
        setActiveTab('note');
        setSavedSuccessMsg("স্বয়ংক্রিয় ড্রাফটিং সফলভাবে সম্পন্ন হয়েছে!");
  ...
  // File Upload Helper
  const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>, type: 'reply' | 'evidence') => {
  ...
  return (
    <div id="document-management-root" className="w-full min-h-screen bg-slate-100 flex flex-col text-slate-800">
      ...
      <main className="flex-1 max-w-[1200px] w-full mx-auto p-4 md:p-6 flex flex-col gap-6">
        ...
        {/* ========================================================= */}
        {activeTab === 'ai' && (
          <div id="ai-draft-container" className="bg-white rounded-xl shadow-md border border-slate-200 p-6 md:p-10 flex flex-col gap-6">
            <div className="flex items-center gap-3 border-b border-slate-200 pb-4">
              ...
              <div>
                <h3 className="text-base md:text-lg font-bold text-slate-800">
                  AI স্বয়ংক্রিয় ড্রাফটিং ও প্রমাণক বিশ্লেষক
                </h3>
                <p className="text-xs text-slate-500">
                  প্রতিষ্ঠানের প্রেরিত জবাব ও সংযুক্ত প্রমাণক আপলোড বা পেস্ট করে সম্পূর্ণ নির্ভুল নোটশীট ও জারিপত্র তৈরি করুন।
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="border border-slate-200 rounded-xl p-4 bg-slate-50 flex flex-col gap-3">
                ...
                />
                <div className="flex items-center gap-2">
                  <label className="cursor-pointer text-xs font-semibold px-3 py-1.5 bg-white border border-slate-300 text-slate-700 rounded-md hover:bg-slate-100 flex items-center gap-1.5 transition-colors">
              ...
              <div className="border border-slate-200 rounded-xl p-4 bg-slate-50 flex flex-col gap-3">
                <label className="text-xs font-bold text-slate-800 flex items-center justify-between">
                  <span>২. সংযুক্ত প্রমাণক (ভাউচার/স্টেটমেন্ট/চালান):</span>
                  {evidenceFile && (
                    <span className="text-[11px] font-normal text-emerald-700 truncate max-w-[150px]">
              ...
              >
                {isAnalyzing ? (
                  ...
                  <>
                    ...
                    <span>স্বয়ংক্রিয় ড্রাফট তৈরি করুন</span>
                  </>
                )}
              </button>
              <p className="text-[11px] text-slate-500 text-center">
                * ড্রাফট প্রস্তুত শেষে তা স্বয়ংক্রিয়ভাবে নোটশীট ও জারিপত্রে যুক্ত হবে যা আপনি প্রয়োজন অনুযায়ী পরিমার্জন করতে পারবেন।
              </p>
            </div>
          </div>
        )}
