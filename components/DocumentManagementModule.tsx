  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-4 pb-20 animate-in fade-in duration-300">
      ...
      >
        ...
        {/* জারিপত্রের ৬-কলাম ছক ও কলাম-সারি বিন্যাস ও নিয়ন্ত্রণ (Note Sheet-based Jaripatra Table Setup) */}
        <div className="no-print pt-4 space-y-3 border-t-2 border-indigo-200">
          <div className="bg-indigo-50/70 border-2 border-indigo-300 p-3.5 space-y-3">
            <div className="flex flex-wrap items-center justify-between gap-2 border-b border-indigo-200 pb-2.5">
              <div className="flex items-center gap-2">
                <div className="w-7 h-7 bg-indigo-700 text-white flex items-center justify-center font-black">
                  <Table size={15} />
                </div>
                <div>
                  <h3 className="text-xs sm:text-sm font-black text-indigo-950 flex items-center gap-1.5">
                    <span>জারিপত্রের ছক ও কলাম/সারি বিন্যাস ও নিয়ন্ত্রণ</span>
                    <span className="px-2 py-0.5 bg-indigo-200 text-indigo-900 text-[10px] font-black">
                      Note Sheet Control
                    </span>
                  </h3>
                  <p className="text-[11px] text-slate-600 font-bold">
                    জারিপত্রে প্রদর্শিতব্য ছকের কলাম, সারি, শিরোনাম ও তথ্যসমূহ এখান থেকেই কাস্টমাইজ করুন
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center flex-wrap gap-1.5">
                <button
                  type="button"
                  onClick={handleSyncJaripatraFromParagraphs}
                  className="px-2.5 py-1 bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs flex items-center gap-1 cursor-pointer shadow-2xs"
                  title="নোট শিটের সকল অনুচ্ছেদ থেকে স্বয়ংক্রিয়ভাবে জারিপত্রের সারি প্রস্তুত করুন"
                >
                  <Sparkles size={12} className="text-amber-300" />
                  <span>অনুচ্ছেদ থেকে ছকে আনুন</span>
                </button>

                <button
                  type="button"
                  onClick={handleAutoNumberRows}
                  className="px-2 py-1 bg-white hover:bg-slate-100 text-slate-700 border border-slate-300 font-bold text-xs flex items-center gap-1 cursor-pointer shadow-2xs"
                ...
                <button
                  ...
                  className="px-2 py-1 bg-amber-100 hover:bg-amber-200 text-amber-900 border border-amber-300 font-bold text-xs flex items-center gap-1 cursor-pointer"
                ...
                <button
                  ...
                  className="px-2 py-1 bg-white hover:bg-red-50 text-red-600 border border-slate-300 font-bold text-xs flex items-center gap-1 cursor-pointer"
            ...
            {/* Table Guide Box */}
            {showTableGuide && (
              <div className="bg-amber-50 border border-amber-300 p-2.5 text-[11px] text-amber-900 space-y-1 animate-in fade-in duration-150">
                ...
                <ul className="list-disc list-inside space-y-0.5 text-slate-700">
                  ...
                  <li><strong>সারি যুক্ত/ডিলিট:</strong> প্রতিটি সারির ১ম কলামের বামপাশে মাউস নিলে <span className="font-bold text-emerald-600">+উপরে</span>, <span className="font-bold text-emerald-600">+নিচে</span> সারি যোগ ও <span className="font-bold text-red-600">মুছুন</span> অপশন আসবে।</li>
                  <li><strong>সেল মার্জ (Merge):</strong> যেকোনো সেলের উপর মাউস নিয়ে ডানপাশের মেনুতে <strong>'ডানে মার্জ'</strong> বা <strong>'নিচে মার্জ'</strong> বাটন চাপুন।</li>
                  <li><strong>আনমার্জ (Unmerge):</strong> মার্জ করা সেলের উপর মাউস নিয়ে <strong>'আনমার্জ'</strong> বাটন চেপে পূর্বের অবস্থায় ফিরিয়ে নিন।</li>
            ...
            {/* Top Toolbar */}
            <div className="flex flex-wrap items-center justify-between gap-1.5 bg-white p-2 border border-indigo-200 text-xs">
              <div className="flex flex-wrap items-center gap-1.5">
                <span className="font-bold text-slate-700 flex items-center gap-1 mr-1">
                  <Table size={13} className="text-blue-600" /> দ্রুত যোগ:
                </span>

                {/* Row Controls */}
                <div className="inline-flex border border-slate-300 bg-white overflow-hidden shadow-2xs">
                  <button
                    type="button"
              ...
              <span className="text-[11px] text-slate-500 font-bold">
                মোট সারি: <strong className="text-slate-800">{toBengaliDigits(jaripatraGridRows.length)}</strong>টি | মোট কলাম: <strong className="text-slate-800">{toBengaliDigits(jaripatraColumns.length)}</strong>টি
              </span>
            </div>

            {/* Note Sheet-based Jaripatra Table Editor */}
            <div className="overflow-x-auto bg-white p-2 border border-indigo-200 shadow-xs">
              <table className="w-full border-collapse border-2 border-black text-xs sm:text-[12px]">
                <thead>
                  {/* Column Header Titles */}
                  <tr className="bg-slate-100 font-bold border-b border-black text-center">
                    {jaripatraColumns.map((col, cIdx) => (
                      ...
                      >
                        <div className="space-y-1">
                          {/* Column Controls */}
                          <div className="flex items-center justify-center gap-0.5 opacity-0 group-hover/col:opacity-100 transition-opacity bg-slate-200 py-0.5 px-1 text-[10px] text-slate-700 mb-1">
                            <button
                              type="button"
                          ...
                          <input
                            type="text"
                            className="w-full text-center font-bold text-black bg-transparent outline-none hover:bg-slate-200/60 focus:bg-blue-50 focus:border-b focus:border-blue-500"
                            value={col.label}
                            onChange={(e) => handleUpdateColumnHeader(col.id, e.target.value, col.subLabel)}
                          />
                        </div>
                  ...
                  <tr className="bg-slate-50 font-bold border-b border-black text-center text-[11px]">
                    {jaripatraColumns.map((col) => (
                      <th key={`sub-${col.id}`} className="border border-black p-0.5 text-center">
                        <input
                          type="text"
                          className="w-full text-center font-bold text-black bg-transparent outline-none hover:bg-slate-200 focus:bg-blue-50"
                          value={col.subLabel}
                          onChange={(e) => handleUpdateColumnHeader(col.id, col.label, e.target.value)}
                        />
                      </th>
                ...
                <tbody>
                  {jaripatraGridRows.map((row, rIdx) => (
                    <tr key={row.id} className="align-top hover:bg-slate-50/60 group/row">
                      {jaripatraColumns.map((col, cIdx) => {
                        const cell = row.cells[col.id];
                        if (!cell || cell.isHidden) return null;
                        ...
                        return (
                          <td
                            ...
                            className={`border border-black p-1.5 relative group/cell ${
                              isMerged ? "bg-amber-50/40" : ""
                            }`}
                          >
                            {/* Left Row Handle on 1st column */}
                            {cIdx === 0 && (
                              <div className="absolute -left-1 top-1 -translate-x-full opacity-0 group-hover/row:opacity-100 transition-opacity flex flex-col gap-0.5 bg-white border border-slate-300 shadow-md p-0.5 z-20">
                                <button
                                  type="button"
                            ...
                            {/* Cell Controls (Merge, Align, Bold) */}
                            <div className="absolute right-1 top-1 opacity-0 group-hover/cell:opacity-100 transition-opacity z-10">
                              <div className="flex items-center gap-0.5 bg-white/95 border border-slate-300 shadow-sm px-1 py-0.5 text-[10px]">
            ...
            {/* Bottom Add Row/Col bar */}
            <div className="flex flex-wrap items-center justify-between gap-2 text-xs pt-1">
              <div className="flex items-center gap-2">
                <button
                  type="button"
                  onClick={() => handleAddRow(jaripatraGridRows.length - 1, 'below')}
                  className="px-3 py-1 bg-white hover:bg-slate-100 text-slate-700 border border-slate-300 font-bold flex items-center gap-1 cursor-pointer"
                >
