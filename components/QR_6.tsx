...
const QR_6: React.FC<QRProps> = ({ activeCycle, IDBadge, searchTerm = '', filterMinistry = '' }) => {
  ...
  return (
    <div id="qr-6-container" className="w-full mx-auto p-8 bg-white rounded-xl border border-slate-300 shadow-2xl relative animate-in fade-in duration-500 font-sans flex flex-col min-h-[calc(100vh-120px)]">
      ...
      <div className="table-container qr-table-container overflow-auto border border-slate-400 shadow-sm rounded-lg flex-grow min-h-[600px]">
        <table className="w-full border-separate border-spacing-0 min-w-[850px] !table-auto min-h-full">
