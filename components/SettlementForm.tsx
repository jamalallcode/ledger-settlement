...
import { Trash2, Sparkles, X, Building2, Building, AlertCircle, CheckCircle2, Calendar, FileText, Hash, Banknote, Archive, BookOpen, Send, Files, FileEdit, ClipboardList, Layout, Fingerprint, Info, BarChart3, ListOrdered, Timer, Plus, Check, ShieldCheck, Trash } from 'lucide-react';
...
const SettlementForm: React.FC<SettlementFormProps> = ({ onAdd, nextSl, branchSuggestions, initialEntry, onCancel, isLayoutEditable, isAdmin = false }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const finalData = {
      ...formData, isMeeting: formData.meetingType !== 'বিএসআর', paragraphs, cycleLabel, isLate, actualEntryDate: now.toISOString(), involvedAmount: paraInvTotal + (formData.meetingUnsettledAmount || 0),
