                ...
                {sessionUserEmail ? (
                  <div className="flex flex-col items-end gap-1">
                    ...
                    <button
                      ...
                      className="text-[10px] text-red-300 hover:text-red-100 underline cursor-pointer"
                    >
                      সাইন-আউট করুন
                    </button>
                  </div>
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-white hover:bg-slate-100 text-slate-900 rounded-lg text-xs font-black transition-all flex items-center gap-1.5 shadow-md cursor-pointer active:scale-95 border border-slate-200"
