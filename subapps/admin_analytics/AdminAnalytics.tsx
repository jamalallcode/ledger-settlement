              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50">
                    <th 
                      className="sticky top-0 md:top-[var(--sticky-top)] bg-slate-50 px-4 py-2.5 text-[10px] font-black text-slate-400 uppercase tracking-widest z-40 shadow-sm"
                    >
                      অডিটরের নাম
                    </th>
                    <th 
                      className="sticky top-0 md:top-[var(--sticky-top)] bg-slate-50 px-4 py-2.5 text-[10px] font-black text-slate-400 uppercase tracking-widest text-center z-40 shadow-sm"
                    >
                      মোট চিঠি
                    </th>
                    <th 
                    ...
                    <th 
                      className="sticky top-0 md:top-[var(--sticky-top)] bg-slate-50 px-4 py-2.5 text-[10px] font-black text-slate-400 uppercase tracking-widest text-right z-40 shadow-sm"
                    >
                      অ্যাকশন
                    </th>
                  </tr>
