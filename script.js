...
const MINISTRY_ENTITY_MAP = {
  ...
  "বিমান ও পর্যটন মন্ত্রণালয়": ["বাংলাদেশ বিমান", "পর্যটন কর্পোরেশন"],
...
const ReturnView = ({ entries, cycleLabel, prevStats, setPrevStats, onDemoLoad }) => {
  ...
  const ministryGroups = ['আর্থিক প্রতিষ্ঠান বিভাগ', 'পাট মন্ত্রণালয়', 'বস্ত্র মন্ত্রণালয়', 'শিল্প মন্ত্রণালয়', 'বিমান ও পর্যটন মন্ত্রণালয়', 'বাণিজ্য মন্ত্রণালয়'];
